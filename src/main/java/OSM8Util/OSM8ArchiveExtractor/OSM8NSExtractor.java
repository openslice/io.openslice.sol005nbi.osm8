...
public class OSM8NSExtractor implements OSMNSExtractor{
	private static final Logger logger = LogManager.getLogger(OSM8NSExtractor.class);
	...
	public OSM8NSExtractor(File NSDescriptorFile) {
