 ...
 * =========================LICENSE_END==================================
 */
package OSM8Util.OSM8ArchiveExtractor;
...
public class OSM8VNFDExtractor implements OSMVNFDExtractor{

	private static final Logger logger = LogManager.getLogger(OSM8VNFDExtractor.class);
	...
	public OSM8VNFDExtractor(String filePath) {
...
//					catch(Exception e)
//					{
//						logger.error("Cannot read file " + entry.getName());
//					}
//					    					   
...
//						//}                        	
//					}else {
//						logger.error("ERROR: " + entry.getName() + " does not contain vnfd tag! " );
//					}
