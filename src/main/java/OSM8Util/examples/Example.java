...
public class Example {
    ...
    public static void main(String[] args) throws IOException {
        ...
        OSM8VNFDExtractor vnfCirrosExtract = new OSM8VNFDExtractor(cirrosVnfFile.getPath());
        Vnfd cirrosVnfDescriptor = vnfCirrosExtract.extractVnfdDescriptor();
        OSM8VNFRequirements cirrosVnfRequirements = new OSM8VNFRequirements(cirrosVnfDescriptor);
