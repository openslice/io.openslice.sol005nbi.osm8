...
import org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.vnfd.base.rev170228.virtual._interface.VirtualInterface;
...
public class InterfaceBuilder implements Builder<Interface> {
    ...
    public InterfaceBuilder(org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.vnfd.base.rev170228.VirtualInterface arg) {
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.vnfd.base.rev170228.VirtualInterface</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.vnfd.base.rev170228.VirtualInterface) {
            this._virtualInterface = ((org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.vnfd.base.rev170228.VirtualInterface)arg).getVirtualInterface();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.urn.etsi.osm.yang.vnfd.base.rev170228.VirtualInterface]");
    }
