...
/**
 * Class that builds {@link MemQuotaBuilder} instances.
 * 
 * @see MemQuotaBuilder
 *
 */
public class MemQuotaBuilder implements Builder<MemQuota> {
    ...
    public MemQuotaBuilder(MemQuota base) {
        ...
        if (base instanceof MemQuotaImpl) {
            MemQuotaImpl impl = (MemQuotaImpl) base;
    ...
    */
    ...
    private static final class MemQuotaImpl implements MemQuota {
    
        private final BigInteger _limit;
        private final BigInteger _reserve;
        private final BigInteger _shares;
    
        private Map<Class<? extends Augmentation<MemQuota>>, Augmentation<MemQuota>> augmentation = Collections.emptyMap();
        ...
        @Override
        public Class<MemQuota> getImplementedInterface() {
            return MemQuota.class;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (!MemQuota.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<MemQuota>>, Augmentation<MemQuota>> e : augmentation.entrySet()) {
