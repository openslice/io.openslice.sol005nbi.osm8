    ...
    VcaConfigAccess
{
    ...
    public static final QName QNAME = $YangModuleInfoImpl.qnameOf("kdu-configuration");

    /**
     * List of blacklisted config primitives from the list ofdefault kdu config 
     * primitives
     *
     *
     *
     ...
     */
    @Nullable
    List<BlacklistConfigPrimitive> getBlacklistConfigPrimitive();
