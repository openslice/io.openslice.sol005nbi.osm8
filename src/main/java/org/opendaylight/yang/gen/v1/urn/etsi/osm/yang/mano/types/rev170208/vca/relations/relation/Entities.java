    ...
    Identifiable<EntitiesKey>
{
    ...
    public static final QName QNAME = $YangModuleInfoImpl.qnameOf("entities");

    /**
     * A string, reference to the element id in the descriptor.It could be a vnfd-id or
     * a vdu-id in a VNFD,or a nsd-id or member-vnf-index in a NSD.
     *
     *
     *
