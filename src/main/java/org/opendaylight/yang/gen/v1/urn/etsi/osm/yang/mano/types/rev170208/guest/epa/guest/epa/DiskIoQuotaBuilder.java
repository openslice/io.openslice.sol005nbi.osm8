...
/**
 * Class that builds {@link DiskIoQuotaBuilder} instances.
 * 
...
public class DiskIoQuotaBuilder implements Builder<DiskIoQuota> {
    ...
    public DiskIoQuotaBuilder(DiskIoQuota base) {
        ...
        if (base instanceof DiskIoQuotaImpl) {
            DiskIoQuotaImpl impl = (DiskIoQuotaImpl) base;
    ...
    */
    ...
    private static final class DiskIoQuotaImpl implements DiskIoQuota {
    
        private final BigInteger _limit;
        private final BigInteger _reserve;
        private final BigInteger _shares;
    
        private Map<Class<? extends Augmentation<DiskIoQuota>>, Augmentation<DiskIoQuota>> augmentation = Collections.emptyMap();
        ...
        @Override
        public Class<DiskIoQuota> getImplementedInterface() {
            return DiskIoQuota.class;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (!DiskIoQuota.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<Class<? extends Augmentation<DiskIoQuota>>, Augmentation<DiskIoQuota>> e : augmentation.entrySet()) {
