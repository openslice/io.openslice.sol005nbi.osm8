    ...
    Augmentable<K8sCluster>
{
    ...
    public static final QName QNAME = $YangModuleInfoImpl.qnameOf("k8s-cluster");

    /**
     * List of supported K8s versions.The cluster where the KDUs will be deployed will 
     * have to matchone of these versions.
     *
     *
     *
     ...
     * have to useone of these CNI plugins.
     *
     *
     *
     ...
     *
     *
     * @return <code>java.util.List</code> <code>nets</code>, or <code>null</code> if not present
     */
    @Nullable
    List<Nets> getNets();
